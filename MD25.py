...
class MD25 :
  ...
  def forward(self, speed=127):
    self.i2c.write8(self.__MD25_SPEED_1, speed+128)
    self.i2c.write8(self.__MD25_SPEED_2, speed+128)

  def stop(self):
    self.i2c.write8(self.__MD25_SPEED_1, 128)
    self.i2c.write8(self.__MD25_SPEED_2, 128)

  def turn(self, speed1=127, speed2=-127):
    self.i2c.write8(self.__MD25_SPEED_1, speed1+128)
    self.i2c.write8(self.__MD25_SPEED_2, speed2+128)
